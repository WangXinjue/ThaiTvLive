...
public class SampleChooserActivity extends Activity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    ExpandableListView sampleListView = findViewById(R.id.recycle_view_list);
  ...
  public boolean onChildClick(
    ...
    //mark by wxj 2018-08-22 跳转播放的activity
    Log.d("wxj", "onChildClick: jump to playerActivity");
  ...
  private final class SampleAdapter extends BaseExpandableListAdapter implements OnClickListener {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
      ...
      //Mark By wxj 2016-08-22 这里是替换title的地方
    ...
    public void onClick(View view) {
      //mark by wxj 2018-08-22 这里是点击下载的位置
      Log.d("wxj", "onClick: download");
